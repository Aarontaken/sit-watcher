...
前往 [Releases](https://github.com/Aarontaken/sit-watcher/releases) 下载最新的 `SitWatcher.dmg`。

1. 双击 `.dmg` 文件打开
2. 双击 **`Install.command`** 即可自动安装并启动

> 首次安装时会弹出「Install.command 是从互联网下载的脚本」提示，点击「打开」即可。
