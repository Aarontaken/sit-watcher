...
**SitWatcher** 是一款运行在 **Mac 菜单栏** 上的开源 **久坐提醒 / 起身提醒 / 站立提醒** 小工具：久坐倒计时结束后先弹出浮窗，可延后；若长时间不理会会升级为全屏遮罩，直到你确认「已经站起来」，帮你打断连续久坐。

如果你在用 GitHub 搜索 **「久坐提醒」「久坐」「起身提醒」「站立提醒」「菜单栏提醒」**，本项目就是这些关键词所指的一类工具——专治「一坐一下午忘了动」。
